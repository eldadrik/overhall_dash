...
export async function getHotBetBucket() {
  ...
  return {
    ...
    caption: "Selected by Interesting Score: uncertainty, price move, attention shock, urgency, topic, liquidity, and sports/spam penalty. Crypto markets are excluded."
  };
}
